...
imputFrame = ttk.Frame(backgroundFrame, padding="10 10 10 10")
imputFrame.grid(row=0, column=0)
ttk.Label(imputFrame, text="Nombre").grid(row=0, column=0, sticky=W)
ttk.Entry(imputFrame).grid(row=0, column=1, sticky=E)
ttk.Label(imputFrame, text="A. Paterno").grid(row=1, column=0, sticky=W)
ttk.Entry(imputFrame).grid(row=1, column=1, sticky=E)
ttk.Label(imputFrame, text="A. Paterno").grid(row=2, column=0, sticky=W)
ttk.Entry(imputFrame).grid(row=2, column=1, sticky=E)
ttk.Label(imputFrame, text="Correo").grid(row=3, column=0, sticky=W)
ttk.Entry(imputFrame).grid(row=3, column=1, sticky=E)
ttk.Label(imputFrame, text="Movil").grid(row=4, column=0, sticky=W)
ttk.Entry(imputFrame).grid(row=4, column=1, sticky=E)
...
selectFrame = ttk.Frame(backgroundFrame, padding="10 30 10 30")
...
cancelBtn.grid(row=0, column=1, sticky=W)
